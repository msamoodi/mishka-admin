  ...
  return (
    ...
    <form onSubmit={handleSubmit} className="max-w-2xl flex flex-col gap-5">
      ...
      <div className="flex items-center gap-3">
        ...
        <button type="button" onClick={() => router.push(`/admin/courses/${courseId}/lessons`)} className="h-9 px-4 text-sm font-medium text-gray-600 hover:bg-gray-100 rounded-lg transition-colors">
          Cancel
        </button>
      </div>
    </form>
