  ...
  return (
    <div className="p-8">
      <div className="mb-6">
        ...
        <Link href={`/admin/courses/${id}`} className="text-sm text-gray-500 hover:text-gray-900">{course.course_name}</Link>
      ...
      <div className="flex items-center gap-3 mb-4">
        <Link
          href={`/admin/courses/${id}/lessons/new?type=content`}
        ...
        <Link
          href={`/admin/courses/${id}/lessons/new?type=quiz`}
