...
export default function CategoriesClient({ categories: initial }: { categories: Category[] }) {
  ...
  const handleCreate = async (e: React.FormEvent) => {
    ...
    const res = await fetch(withBasePath("/api/admin/create-category"), {
      method: "POST",
  ...
  const saveEdit = async (id: string) => {
    ...
    setUpdating(true)
    const res = await fetch(withBasePath("/api/admin/update-category"), {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  const handleDelete = async (id: string) => {
    ...
    setDeletingId(id)
    const res = await fetch(withBasePath("/api/admin/delete-category"), {
      method: "POST",
      headers: { "Content-Type": "application/json" },
