      ...
      {value && (
        <div className="flex items-center gap-3 px-3 py-2 bg-gray-50 border border-gray-200 rounded-lg">
          {value.startsWith("http") ? (
            ...
            <img src={value} alt="" className="w-10 h-10 rounded-md object-cover bg-gray-200 flex-shrink-0" />
          ) : (
            <div className="w-10 h-10 rounded-md bg-gray-200 flex-shrink-0 flex items-center justify-center text-lg">🖼️</div>
          )}
